...
def placement_summary():
    return {
        ...
        "featured_package": "9 LPA",
        "featured_student": "Girija Rama Amallika",
        "featured_company": "Google",
        "placed_students": 487,
        "companies_participated": 26,
        "drives_conducted": 38,
        "top_branches": ["CSE", "ECE", "EEE", "MECH"],
    }
...
def success_stories():
    return render_template("success_stories.html", summary=placement_summary())
